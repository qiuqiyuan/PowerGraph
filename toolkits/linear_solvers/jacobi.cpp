...
int data_size = 5; //qqiu: How do we know that this is always 5?
...
public:
    ...
    gather_type() {
        training_rmse = validation_rmse = 0;
    }

    void save(graphlab::oarchive& arc) const {
        arc << pvec << training_rmse << validation_rmse;
    }
...
int main(int argc, char** argv) {
    ...
    //qqiu: why do I need to init_math here after I have parsed command line argument?
    ...
    PRINT_VEC(x);
    PRINT_VEC(A_ii);
    //qqiu: This loop is the main computation
